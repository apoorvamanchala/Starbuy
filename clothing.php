...
<h2 class="heading">Latest Trending Clothes</h2>
<?php
$connect = mysqli_connect("localhost", "root", "", "starbuy");
$query = "SELECT * FROM tbl_product WHERE department_name='Clothing' LIMIT 6";
        ...
        <div class="rowname">
            <div class="columnname">
              <form method="post" action="cart.php?action=add&id=<?php echo $row["id"]; ?>">
                    ...
                    <div class="Sale" style="color: rgb(255, 255, 255); width: 120px; background: rgb(204, 12, 57);">
        <?php if ($row['DiscountPrice'] <= 0) {
            echo "New";
        } else {
            echo 'Upto ' . $row['DiscountPer'];
        } ?></div>	
