<?php $title="Today's Deal Shopping Cart"; ?>
...
background-size: cover;
 ...
 <h2 class="heading">Today's Deal in Clothing, Shoes & Toys</h2>
 
<?php  
				$connect = mysqli_connect("localhost", "root", "", "starbuy"); 
                $query = "SELECT * FROM `tbl_product` WHERE DiscountPrice>0 LIMIT 6";  
